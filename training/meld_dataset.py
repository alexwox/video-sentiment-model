...
class MELDDataset(Dataset):
    ...
    def _load_video_frames(self, video_path):
        ...
        try: 
            ...
            #Reset index to avoid frame skio
            ...
            raise ValueError(f"Video error: {str(e)}") from e
        finally:
            cap.release()
    ...
    def _extract_audio_features(self, video_path):
        ...
        try:
            ...
            raise ValueError(f"Audio extraction failed {str(e)}") from e
        except Exception as e:
            raise ValueError(f"Audio error {str(e)}") from e
        finally:
